def compute_overlap_f1(predicted_spans, gold_spans):
    """
...
# Usage in your evaluation:
def evaluate(predicted, gold):
    """Evaluate with overlap F1"""
    return compute_overlap_f1(predicted, gold)


# # Example:
# predicted = [
#     {'text': 'Apple Inc', 'label': 'ORG', 'start': 0, 'end': 9},
#     {'text': 'Cupertino', 'label': 'LOC', 'start': 16, 'end': 25}
# ]
# gold = [
#     {'text': 'Apple', 'label': 'ORG', 'start': 0, 'end': 5},  # Partial overlap
#     {'text': 'Cupertino', 'label': 'LOC', 'start': 16, 'end': 25}  # Exact match
# ]
