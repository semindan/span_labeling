...
if __name__ == "__main__":
    ...
    parser.add_argument("lang", default="English", help="Name of the target language of the essays (in English)")
    parser.add_argument("mode", default="minimal", help="Which kind of correction to use; must be one of minimal|fluency")
